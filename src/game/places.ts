...
export const PLACES: Place[] = [
  ...
  { id: 'cmg',   name: 'Camagüey ',   backgroundKey: 'cmg-bg',   targetScore: 600, emoji: '🏙️', color: '#3498db' },
  { id: 'vcl',   name: 'Villa Clara',   backgroundKey: 'vcl-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'hlg',   name: 'Holguín',   backgroundKey: 'hlg-bg', targetScore: 800, emoji: '�️', color: '#f1c40f' },
  { id: 'cfg',   name: 'Cienfuegos',   backgroundKey: 'cfg-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'pri',   name: 'Pinar del Río',   backgroundKey: 'pri-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'art',   name: 'Artemisa ',   backgroundKey: 'art-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'myb',   name: 'Mayabeque ',   backgroundKey: 'myb-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'ssp',   name: 'Sancti Spíritus',   backgroundKey: 'ssp-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'ltn',   name: 'Las Tunas',   backgroundKey: 'ltn-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'grm',   name: 'Granma ',   backgroundKey: 'grm-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'stg',   name: 'Santiago de Cuba',   backgroundKey: 'stg-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'gtm',   name: 'Guantánamo ',   backgroundKey: 'gtm-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
  { id: 'ijv',   name: 'Isla de la Juventud',   backgroundKey: 'ijv-bg', targetScore: 800, emoji: '🌋', color: '#e74c3c' },
